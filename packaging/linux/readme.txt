...
Know Issues
-----------
When running on an old machine, you may run into the problem were Matlab needs a newer version of libstdc++ tha the
one of the machine. This can be addressed by preloading the libstdc++ version need by Matlab when you start RasCAL as
below (replace the path to matlab as appropriate)
